...
import com.xht.androidnote.databinding.ActivityMultiSelectBinding
 ...
 */
class MultiSelectActivity : BaseViewActivity<ActivityMultiSelectBinding>() {

    lateinit var clientList: List<ClientInfo>
    override fun getViewBinding(): ActivityMultiSelectBinding {
        return ActivityMultiSelectBinding.inflate(layoutInflater)
    }
    ...
    override fun initEventAndData() {
        ...
        //注册选择器
        checkHelper.register(
            ClientInfo::class.java,
            object : CheckHelper.Checker<ClientInfo?, MultiSelectAdapter.MultiSelectViewHolder> {
                override fun check(
                    s: ClientInfo?,
        ...
        binding.btnSelectList.setOnClickListener {

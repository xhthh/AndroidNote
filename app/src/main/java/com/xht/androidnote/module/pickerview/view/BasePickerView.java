package com.xht.androidnote.module.pickerview.view;
...
import com.xht.androidnote.module.pickerview.listener.OnDismissListener;
import com.xht.androidnote.module.pickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews(int backgroudId) {
        ...
        if (isDialog()) {
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.pickerview_layout_base, decorView, false);
